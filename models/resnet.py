...
def ResNet34():
    '''
    Returns an initialized ResNet with 34 layers
    '''
    return ResNet(BasicBlock, [3,4,6,3])

def ResNet50():
    '''
    Returns an initialized ResNet with 50 layers
    '''
    return ResNet(Bottleneck, [3,4,6,3])

def ResNet101():
    '''
    Returns an initialized ResNet with 101 layers
    '''
    return ResNet(Bottleneck, [3,4,23,3])

def ResNet152():
    '''
    Returns an initialized ResNet with 152 layers
    '''
